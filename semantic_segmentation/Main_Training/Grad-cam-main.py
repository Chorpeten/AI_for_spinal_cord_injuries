...
parser.add_argument('--resume',default=r'/home/biocinformatic/Desktop/nowproject/UCTtransNet/SpinalCordInjury/UCTransNet_pretrain/Test_session_11.30_22h27/models/best_model-UCTransNet_pretrain.pth.tar',
                    help='加载的模型路径')
parser.add_argument('--img_src', default='/home/biocinformatic/Desktop/nowproject/UCTtransNet/datasets/SpinalCordInjury/Test_filter/img/b_l.png',
                    help='单张图片src路径')
parser.add_argument('--img_gt', default='/home/biocinformatic/Desktop/nowproject/UCTtransNet/SpinalCordInjury_visualize_test/b_l_predict.png',
                    help='单张图片gt路径')
